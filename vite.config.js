	...
	plugins: [
		UnoCSS({
			shortcuts: {
				...
				"btn-primary":
					"bg-primary-400 transition-transform active:(bg-primary-100 translate-y-1) hover:bg-primary-200 p-2 rounded-lg shadow-md",
				"btn-secondary":
					"bg-secondary-400 transition-transform active:(bg-secondary-100 translate-y-1) hover:bg-secondary-200 p-2 rounded-lg shadow-md",
			},
			safelist:
          ...
          btn-primary btn-secondary`.split(" "),
			theme: {},
			presets: [
				presetUno(),
				presetTheme({
