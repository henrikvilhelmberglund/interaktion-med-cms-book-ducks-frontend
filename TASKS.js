...
!- (VG) - Profilsidan ska även innehålla en lista över samtliga böcker som den användaren betygsatt. Dessa ska kunna sorteras på titel, författare samt betyg (titel och författare sorteras i bokstavsordning A-Ö, betyg från högst till lägst).
